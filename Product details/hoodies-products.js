        ...
        card.innerHTML = `
            <div class="card m-2 pb-md-5 px-md-5 border-0">
                <div class="card-details">
                    ...
                    <h6 class="card-title"><strong>${product.productName}</strong></h6>
...
// Initial population
populateProducts(currentPage, pageSize);
populatePagination(products.length, pageSize);
...
document.getElementById("pagination").addEventListener("click", function(event) {
    if (event.target.tagName === "A") {
        ...
        populateProducts(pageNumber, pageSize);
